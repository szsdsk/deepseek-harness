...
import insightRemote from '@deepseek-ai/dsh-api-insight-controller/remote'
...
export type {} from '@deepseek-ai/dsh-api-insight-controller/remote'
export type * from '@deepseek-ai/dsh-api-insight-controller/types'
...
export async function apply(ctx: Context): Promise<() => Promise<void>> {
  ...
  try {
    for (const contribution of [
      ...
      terminalRemote, insightRemote, officeToPdfRemote,
    ]) {
