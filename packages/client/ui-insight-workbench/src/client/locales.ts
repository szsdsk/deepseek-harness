...
export const zh = {
  ...
  'result.rows': '行', 'result.ms': '毫秒', 'result.null': '空值', 'chart.x': '横轴字段', 'chart.y': '纵轴字段',
...
export const en: Record<InsightWorkbenchKey, string> = {
  ...
  'result.rows': 'rows', 'result.ms': 'ms', 'result.null': 'NULL', 'chart.x': 'X-axis column', 'chart.y': 'Y-axis column',
